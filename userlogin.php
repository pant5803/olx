      ...
      <div class="box-root padding-top--24 flex-flex flex-direction--column" style="flex-grow: 1; z-index: 9;">
        ...
        <div class="formbg-outer">
            ...
            <div class="formbg-inner padding-horizontal--48">
              ...
              <form action="loginvalidation.php" method="post" id="stripe-login">
                <div class="field padding-bottom--24">
                  ...
                  <input type="email" name="useremail" value="<?php if (isset($_COOKIE['useremail'])) {
                ...
                <div class="field padding-bottom--24">
                  ...
                  <input type="password" name="userpassword" value="<?php if (isset($_COOKIE['userpassword'])) {
                                                                      echo $_COOKIE['userpassword'];
                                                                    } ?>">
                </div>
                <div class="field field-checkbox padding-bottom--24 flex-flex align-center">
                  <label for="checkbox">
                    <input type="checkbox" name="rememberme"> Stay signed in for a week
                  </label>
                </div>
                <div class="field padding-bottom--24">
          ...
          <div class="footer-link padding-top--24">
            <span>Don't have an account? <a href="usersignup.php">Sign up</a></span>
